...
\begin{document}
    ...
    Na etapa de pré-processamento dos dados, o \textit{dataset} de entrada foi normalizado utilizando a $z-score$ e os rótulos
    (\textit{dataset} de saída) transformados com o processo de \textit{one hot encoding}. A matriz de pesos $\textbf{w}$ utilizada
    na regressão é inicializada através de uma distribuição uniforme na faixa de $]-1,+1[$.

    Ao término do processo de treinamento, o modelo classifica corretamente $98,89\%$ dos padrões de treinamento.
    ...
    \begin{table}[H]
        ...
        \end{tabular}
        \caption{Regressão Logística: Matriz de confusão, \textit{dataset} testes com o modelo explorando a função \textit{softmax}.}
    ...
    \begin{table}[H]
        ...
        \multicolumn{1}{c|}{\textbf{Média macro}} & \multicolumn{1}{c|}{0.897566} & \multicolumn{1}{c|}{0.878676} & \multicolumn{1}{c|}{0.880859} & \multicolumn{1}{c|}{2947} \\ \cline{2-5} 
    ...
    O kNN apresentou desempenho inferior à regressão logística quando a $F1-medida$ macro é a métrica a ser maximizada.
    A regressão logística também apresentou maior precisão, \textit{recall}, acurácia e $F1-$medida.
    Tal resultado se manteve com as métricas ponderadas pelo número de amostras nas classes ou não.
    \begin{table}[H]
        \begin{tabular}{cccccc}
                                                                                                &                                               & \textbf{Precisão}             & \textbf{Recall}               & \textbf{F1-medida}            & \textbf{Acurácia}                              \\ \cline{3-6} 
        \multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Regrassão\\ Logística\end{tabular}}} & \multicolumn{1}{c|}{\textbf{Média macro}}     & \multicolumn{1}{c|}{0.944410} & \multicolumn{1}{c|}{0.939089} & \multicolumn{1}{c|}{0.940363} & \multicolumn{1}{c|}{\multirow{2}{*}{0.940618}} \\ \cline{3-5}
                                                                                                & \multicolumn{1}{c|}{\textbf{Média ponderada}} & \multicolumn{1}{c|}{0.943691} & \multicolumn{1}{c|}{0.940618} & \multicolumn{1}{c|}{0.940761} & \multicolumn{1}{c|}{}                          \\ \cline{3-6} 
        \multirow{2}{*}{\textbf{kNN}}                                                           & \multicolumn{1}{c|}{\textbf{Média macro}}     & \multicolumn{1}{c|}{0.897566} & \multicolumn{1}{c|}{0.878676} & \multicolumn{1}{c|}{0.880859} & \multicolumn{1}{c|}{\multirow{2}{*}{0.885307}} \\ \cline{3-5}
                                                                                                & \multicolumn{1}{c|}{\textbf{Média ponderada}} & \multicolumn{1}{c|}{0.896129} & \multicolumn{1}{c|}{0.885307} & \multicolumn{1}{c|}{0.883887} & \multicolumn{1}{c|}{}                          \\ \cline{3-6} 
        \end{tabular}
        \caption{Comparativo de desempenho da classificação feita pela regressão logística e pela kNN ($k=26$, pesos uniformes).}
        \label{table:ex2_comp}
    \end{table}
\end{document}